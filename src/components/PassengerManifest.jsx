              ...
              <table className="w-full text-left border-collapse min-w-[600px]">
                <thead>
                  <tr className="bg-slate-100 border-y-2 border-slate-300">
                    ...
                    <th className="py-3 px-4 text-[10px] font-extrabold text-slate-600 uppercase text-center">Jenis Kelamin</th>
                ...
                <tbody className="divide-y divide-slate-100 border-b-2 border-slate-300">
                  {booking.passengers.map((p, index) => (
                    <tr key={index} className="hover:bg-slate-50 transition-colors">
                      ...
                      <td className="py-3 px-4 text-xs font-bold text-slate-800 text-center">
                        {p.gender === 'L' ? 'Laki-laki' : p.gender === 'P' ? 'Perempuan' : p.gender || '-'}
                      </td>
